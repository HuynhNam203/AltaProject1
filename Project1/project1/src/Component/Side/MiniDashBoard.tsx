...
import { Col, Layout, Menu, Progress, Row } from "antd";
      ...
      <div className="MiniBoard">
        <Link to="/Dichvu">
          <Row className="sttMDB">
            ...
            <Col span={6}>
              <span className="spanMDB1">4221</span>
              <span className="spanMDB2">
                <DeviceIcon />{" "}
                <span style={{ color: "#ff7506" }}>Thiết bị</span>
              </span>
            </Col>
            <Col span={13}>
              <ul>
        ...
        <Link to="/Dichvu">
          <Row className="sttMDB">
            ...
            <Col span={6}>
              <span className="spanMDB1">276</span>
              <span className="spanMDB2">
                <ServiceIcon />
